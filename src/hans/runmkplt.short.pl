...
#similar to all steps to running mkpltsol, but designed for running in middle of pipeline. 
# thus, it does not run stepZ and step1, as they should already have run. 
