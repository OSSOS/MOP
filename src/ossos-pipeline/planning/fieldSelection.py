...
## for each day in the semester
 sys.stdout.write("%8s | %17s | %17s | %38s  %38s  %38s  \n" % ( "Day", "%Ill Moon-2015 RA", "%Ill Moon-2016 RA", "Min-RA [uptime] (Glat)", "Opp-RA [uptime] (Glat)", "Max-RA [uptime] (Glat)" ) )
 ...
 for day in range(0,360):
    ...
    for ang in range(-20,20,1):
        ...
        uptime = max(0,uptime)
        ## print sun_set, field_rising, both_up_start, Moon.rise_time, Moon.set_time, both_up_end, field_setting, sun_rise, start_time, end_time, uptime
