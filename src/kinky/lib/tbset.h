...
# and defines parameters that may be set by tbpset and/or read by tbpsta.
#
...
# Lengths of character strings for column information.
# Caution!  Print format is limited to seven char plus one for '%'.
define	SZ_COLNAME		19	# Size of a column name
define	SZ_COLUNITS		19	# Size of string for units
define	SZ_COLFMT		9	# Size for print format

# Added 4-Nov-1993 and deleted 7-Dec-1994:
define	TBL_LAST_ROW		Memi[$1+3]	# number of rows in the table
...
# This section defines parameters that may be set or read.
...
define	TBL_TYPE_TEXT		13	# text file
define	TBL_TYPE_FITS		14	# FITS table
define	TBL_TYPE_CDF	15	# don't use this yet!
