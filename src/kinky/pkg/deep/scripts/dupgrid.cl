...
#	print(" copying image 1 ") 
	infile = rootword//1
	outfile = '/users/user2/gladman/Memory-2/' + rootword//'sh1'
	imcopy(infile,outfile)

	getcfh(infile)
	strttime = getcfh.outputime
...
#		print(" xshift ",xsh," and yshift ",ysh) 
		...
		junkfl2 = '/users/user2/gladman/Memory-2/' + rootword + 'sh'
		junkfl2 = junkfl2//i
...
#		imdelete(junkfl2,verify-)
	...
	imglist = '/users/user2/gladman/Memory-2/' + rootword + 'sh*'
	inta = (rate + 0.0001)
	realj = ( (rate-inta)*10 + 0.0001 )
	intb  = realj
	junkfl2 = '/users/user2/gladman/Memory-2/' 
	junkfl2 = junkfl2//'s'//inta//'p'//intb
...
#	imsum(imglist,outfile,title="",option="median",low_rej=0,high_rej=2)
	...
	outfile = '/users/user2/gladman/Memory-2/' + rootword//'sh*'
