#  cfhp.cl    JJ's Plant, using addstar, modified for CFHT
#	(only difference with jjp.cl is signs on direction of motion
#		and using getcfh.cl instead of gettime.cl)
#
...
#	int pobjects  {"", prompt=" number of objects to generate (49 max)"}
	int pnimg     {"", prompt=" number of aligned images"}
        real pfrmsz   {800, prompt=" frame size (pixels) 50 pix padded to y"}
