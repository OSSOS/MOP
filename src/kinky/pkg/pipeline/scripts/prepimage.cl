...
procedure prepimage (image)
	string image {"", prompt="Image to prep"}
	real   fwhm   {4.5,prompt="Estimate of the image quality (FWHM)"}
...
# set the number of images placed in the directory at 0
	...
	makepsf.base="./"
	makepsf(timage,"psf",fwhm=t_fwhm,apmin=3,apmax=15,plant=tplant)
