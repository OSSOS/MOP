...
class Camera:
    ...
    _geometry = {
        ...
        "LBT": [{'dra': 1.3092201073853289, 'ddec': 0.42897343292189305, 'dec': 68.122362962470163,
                 'ra': 56.704997117975871},
                {'dra': 1.3000992865659029, 'ddec': 0.42162904764019515, 'dec': 68.12196936492137,
                 'ra': 56.696558448829173}]
        ,
        "MEGACAM_40": [
