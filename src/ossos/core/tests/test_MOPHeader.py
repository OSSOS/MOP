...
class TestMOPHeader(TestCase):
    ...
    def test_parser_astrom(self):
        ...
        self.assertEquals(mopfile.header.file_ids[0], 'fk1616682s00')
        self.assertEquals(mopfile.header.keywords['ANGLE'][0], '20.0')
    ...
    def test_parser_comb(self):
        ...
        self.assertEquals(mopfile.header.file_ids[0], '1832036p39')
        self.assertEquals(mopfile.header.keywords['ANGLE'][0], '-23.0')
    ...
    def test_match(self):
        ...
        self.assertEquals(match_mopfile.data['real'][0], 0)
        self.assertEquals(match_mopfile.data['real'][1], -1)
